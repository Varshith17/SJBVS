...
const TCForm = props => {
  ...
  useEffect(() => {
    if (props.accountsData) {
      updateData(props.accountsData.transferCertificates[0])
    }
  }, [props.accountsData])
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="modal-body">
          <AvForm className="needs-validation">
            ...
            <Col md="12">
              <div className="mb-3">
                <Label htmlFor="validationCustom03">TC Number</Label>
                <AvField
                  name="tc"
      ...
      <h3>Transfer Certificate Form</h3>
...
export default connect(null, { setBreadcrumbItems })(TCForm)
